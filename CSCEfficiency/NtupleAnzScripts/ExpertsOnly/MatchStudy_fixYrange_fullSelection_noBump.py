...
for idx in range(1,n_stations+1):
    Cut=stations[idx][0]+" && "+DenominatorRequire.replace("#",str(stations[idx][3]))+" && "+MuTrackPairCut + " && CSCRg1==4 && !( ((CSCSegxLc1-CSCLCTxLc1)<-5. && (CSCSegxLc1-CSCLCTxLc1)>-10.) || ((CSCSegxLc1-CSCLCTxLc1)<-14. && (CSCSegxLc1-CSCLCTxLc1)>-20.) )" #+" && "+InvariantMass+#"&& (tracks_phi>4.7996554444 && tracks_phi<5.4977871454)"
